import { Body, Controller, Get, OnModuleInit, Patch, UseGuards } from '@nestjs/common';
...
export class SettingsController implements OnModuleInit {
  ...
  @Patch()
  async updateSettings(@Body() payload: ISettings, @LoggedInUserDecorator() user: ILoggedInUser) {
